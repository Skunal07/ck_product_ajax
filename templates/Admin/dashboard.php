    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0"><?= $countall['productc'] ?></h4>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0"><?= $countall['user'] ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0"><?= $countall['product'] ?></h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
            ...
            <div class="row mb-5 align-items-center">
                <h2>Hey, It's Shopping Time</h2><br>
                <div class="col-md-12 col-lg-6 text-start text-lg-end" data-aos="fade-up" data-aos-delay="100">
                    <div id="filters" class="filters">
                        <?php
                        if ($id == 0) {
                            echo $this->Html->link(__("All"), ['action' => 'dashboard'], ['class' => 'side-nav-link active profile-edit-btn']);
                        } else {
                            echo $this->Html->link(__("All"), ['action' => 'dashboard'], ['class' => 'side-nav-link profile-edit-btn']);
                        }
                        ?>
                        <?php
                        $count = 0;
            ...
            <div class="col-12 mt-4 myapp">
                <?= $this->element('flash/product'); ?>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#key').keyup(function() {
                ...
                // e.preventDefault();
                $.ajax({
                    url: "http://localhost:8765/admin/dashboard",
                    type: "JSON",
                    method: "GET",
                    data: {
                        'key': key,

    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="material-icons opacity-10">table_view</i></div><span class="nav-link-text ms-1">Edit Product</span>' . __(''), ['controller' => 'Admin', 'action' => 'editproduct', $product->id], ['escape' => false, 'title' => __('Tables'), 'class' => 'nav-link text-white active bg-gradient-primary']) ?>
                </li>
                <li class="nav-item">
                ...
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <?= $this->Html->image($product->product_image, array('width' => '400px')); ?>
                        </div>
                            ...
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label for="Product Title">Product Title<span class="text-danger"> *</span></label>
                            </div>
                            <div class="form-group col-sm-8 flex-column d-flex">
                                <?= $this->Form->input('product_title'); ?>
                            </div>
                        </div>
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-4 flex-column d-flex">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-4 flex-column d-flex">
                                <label for="">Product Tags<span class="text-danger"> *</span></label>
                            </div>
                            <div class="form-group col-sm-8 flex-column d-flex">
                                <?= $this->Form->input('product_tags'); ?>
                            </div>
                        </div>

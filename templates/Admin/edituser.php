    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-user-edit opacity-10"></i></div><span class="nav-link-text ms-1">Edit User</span>' . __(''), ['controller' => 'Admin', 'action' => 'tables'], ['escape' => false, 'title' => __('Edit User'), 'class' => 'nav-link text-white active bg-gradient-primary']) ?>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <?= $this->Html->image(h($user->profile_image), array('width' => '200px')) ?>
                    ...
                    <div class="col-md-2">
                        <?= $this->Html->link(__('Cancel'), ['action' => 'tables'], ['class' => 'nav-link profile-edit-btn']) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">

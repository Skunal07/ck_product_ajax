                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <?= $this->Html->link(__('View'), ['action' => 'viewuser', $user->id], ['class' => 'text-secondary font-weight-bold text-xs']) ?>
                                                    <?= $this->Html->link(__('Edit'), ['action' => 'edituser', $user->id], ['class' => 'text-secondary font-weight-bold text-xs']) ?>
                                                    <?= $this->Html->link(__('Delete'), ['action' => 'deleteuser', $user->id], ['class' => 'text-secondary font-weight-bold text-xs']) ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <?php foreach ($categories as $category) { ?>
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <?= $this->Html->link(__('Delete'), ['action' => 'deletecategory', $category->id], ['class' => 'text-secondary font-weight-bold text-xs']) ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                        ...
                                        <?php foreach ($products as $product) { ?>
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    <?= $this->Html->link(__('Delete'), ['action' => 'deleteproduct', $product->id], ['class' => 'text-secondary font-weight-bold text-xs']) ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>

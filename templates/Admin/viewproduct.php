    ...
    <div class="container">
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-6" data-aos="fade-up" style="display:flex;">
                <?php
            if ($user->user_type == 1) {
                echo  $this->Html->link(__('Back to List'), ['action' => 'tables'], ['class' => 'readmore','style'=>'margin-left:300px;']);
                echo  $this->Html->link(__('Edit'), ['action' => 'editproduct',$product->id], ['class' => 'readmore','style'=>'margin-left:30px;']);
            };
            ?>
            </div>
        </div>

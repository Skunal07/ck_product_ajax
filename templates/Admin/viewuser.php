    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="material-icons opacity-10">table_view</i></div><span class="nav-link-text ms-1">View User</span>' . __(''), ['controller' => 'Admin', 'action' => 'viewuser',$user->id], ['escape' => false, 'title' => __('Tables'), 'class' => 'nav-link text-white active bg-gradient-primary']) ?>
                </li>
                <li class="nav-item">
        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-xl-4" style="margin-left: 100px;">
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 text-end">
                                        <?= $this->Html->link('<i class="fas fa-user-edit text-secondary text-sm"></i>' . __(''), ['controller' => 'Admin', 'action' => 'edituser', $user->id], ['escape' => false, 'title' => __(''), 'class' => 'nav-link me-2']) ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?= $this->Html->link(__('Back To List'), ['action' => 'tables'], ['class' => 'btn btn-dark']) ?>
                    </div>
                </div>

            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="row">
                    <div class="col-4 col-xl-4">
                        <?= $this->Html->image($user->profile_image, ['class' => 'w-100 border-radius-lg shadow-sm']) ?>
                        <div class="h-100">
                            <h5 class="mb-1">
                                <?= $user->name ?>
                            </h5>
                    ...
                    <div class="col-8 col-xl-4" style="margin-left: 100px;">
                        <div class="card card-plain h-100">
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 text-end">
                                        <?= $this->Html->link('<i class="fas fa-user-edit text-secondary text-sm"></i>' . __(''), ['controller' => 'users', 'action' => 'edituser', $user->id], ['escape' => false, 'title' => __(''), 'class' => 'nav-link me-2']) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-3">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; <?= $user->contact ?></li>

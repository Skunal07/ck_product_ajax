<body class="g-sidenav-show bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="material-icons opacity-10">dashboard</i></div><span class="nav-link-text ms-1">Dashboard</span>' . __(''), ['controller' => 'Users', 'action' => 'dashboard'], ['escape' => false, 'title' => __('Dashboard'), 'class' => 'nav-link text-white']) ?>
                </li>
                <li class="nav-item">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fa-solid fa-magnifying-glass opacity-10"></i></div><span class="nav-link-text ms-1">View Product</span>' . __(''), ['controller' => 'Users', 'action' => 'viewproduct', $product->id], ['escape' => false, 'title' => __('Tables'), 'class' => 'nav-link text-white active bg-gradient-primary']) ?>
                </li>
        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <section class="section">
                <div class="container">
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-md-6" data-aos="fade-up" style="display:flex;">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-stretch">
                            ...
                            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
                                <div class="sticky-content">
                                    ...
                                    <?= $this->Html->link(__('Visit Website'), ['action' => 'dashboard'], ['class' => 'readmore']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section pt-0">
                ...
                <div class="d-flex flex-row add-comment-section mt-4 mb-4">
                    <?= $this->Html->image($user->profile_image, array('class' => 'd-block ui-w-40 rounded-circle', 'width' => '60px')); ?>
                    <input type="text" name="comments" id="comments"  placeholder="Add comment">
                    <!-- <label for="comments">Add a comment ...</label> -->
                    <hr>
                    <button class="btn btn-primary commentbtn" type="submit">Comment</button>
                    <?= $this->Form->end() ?>
                </div>
                <?php
                ...
                <div class="comments">
                    <?php foreach ($comments as $comment) : ?>
                        <div class="d-flex flex-row mb-2">
                            <?= $this->Html->image($comment->user->profile_image, array('class' => 'd-block ui-w-40 rounded-circle', 'width' => '60px')); ?>
                            <div class="d-flex flex-column ml-2">
                                <span class="name"><?= h($comment->user->name) ?></span>

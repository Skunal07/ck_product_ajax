  ...
  <div class="container-fluid ps-2 pe-0">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item">
          <?= $this->Html->link('<i class="fa fa-chart-pie opacity-6 text-dark me-1"></i>' . __('Dashboard'), ['controller' => 'Users', 'action' => 'dashboard'], ['escape' => false, 'title' => __('Dashboard'), 'class' => 'nav-link me-2']) ?>
        </li>
        <!-- <li class="nav-item">
